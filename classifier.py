...
[개발 category]
- "높음": confirmed groundbreaking or broke-ground article for projects $50M+ or 200+ units; BTR/SFR/Multifamily permit filing or zoning approval; development in LA/Atlanta/Dallas/Houston/Phoenix; BTR/SFR groundbreaking or completion regardless of size; Sun Belt (Atlanta/Dallas/Houston/Phoenix/Charlotte) Multifamily 200+ units development announcement or groundbreaking; LA/West Coast Multifamily 200+ units development announcement or groundbreaking; suburban Atlanta/Dallas/Houston residential development; Student Housing project 500+ beds (not units, beds) OR involving Core Spaces/Landmark/Greystar; Active Adult groundbreaking or completion explicitly confirmed in the article, OR Active Adult development involving institutional capital participation, OR Active Adult development located in Sun Belt (Atlanta/Dallas/Houston/Phoenix/Charlotte) or LA/West Coast — sector membership alone is not sufficient for high relevance; when one of these conditions is met, do not lower relevance merely because unit count or deal size is small
- "보통": general MF development plan announcement in other markets; small-scale groundbreaking under $50M and under 200 units outside Sun Belt; Student Housing project under 500 beds (not units, beds) not involving major platform; Active Adult development plan announcement without confirmed groundbreaking, institutional capital, or Sun Belt/LA-West Coast location
