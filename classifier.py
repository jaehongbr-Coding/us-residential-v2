...
4. Does it involve a Known GP (Kennedy Wilson / Harrison Street / PCCP / Blue Vista / Lionheart / NexMetro / Middleburg / Hillpointe) in any residential deal? → always "높음". This list is exhaustive — no company outside it qualifies as a Known GP, regardless of size or prominence. Company names appearing elsewhere in this prompt (e.g. in sector-specific conditions) are not Known GPs.
...
[개발 category]
- "높음": confirmed groundbreaking or broke-ground article for projects $50M+ or 200+ units; BTR/SFR/Multifamily permit filing or zoning approval; development in LA/Atlanta/Dallas/Houston/Phoenix; BTR/SFR groundbreaking or completion regardless of size; Sun Belt (Atlanta/Dallas/Houston/Phoenix/Charlotte) Multifamily 200+ units development announcement or groundbreaking; LA/West Coast Multifamily 200+ units development announcement or groundbreaking; suburban Atlanta/Dallas/Houston residential development; Student Housing project 500+ beds (not units, beds) OR involving Core Spaces/Landmark/Greystar; Active Adult — ANY ONE of the following conditions is sufficient on its own — they are alternatives, not requirements to be combined: groundbreaking or completion explicitly confirmed in the article, or institutional capital participation explicitly confirmed in the article; Sun Belt (Atlanta/Dallas/Houston/Phoenix/Charlotte) or LA/West Coast location is a supporting factor only when one of these two conditions is already met, and does not by itself qualify a project for "높음"; when one of the two conditions is met, do not lower relevance merely because unit count or deal size is small
- "보통": general MF development plan announcement in other markets; small-scale groundbreaking under $50M and under 200 units outside Sun Belt; Student Housing project under 500 beds (not units, beds) not involving major platform; Active Adult development plan announcement without confirmed groundbreaking or institutional capital participation
